...
| Hydration / electrolyte balance | 4.00 | 4.00 | 4.00 |
| GI tolerance | 7.25 | 7.60 | 8.00 |
| Onset speed | 6.25 | 5.92 | 5.21 |
| Shelf stability / commercial readiness | 7.45 | 7.45 | 8.70 |
| **Overall average** | **7.09** | **6.99** | **6.76** |

## Layer comparison

| Formula | Biological potential | Formulation feasibility | Final deliverable average |
|---|---:|---:|---:|
| V3.1 Dilution-Labeled Hybrid (5 mL core into 40 mL water + dry activator) | 7.36 | 7.17 | 7.09 |
| V3.2 Light-Core Dilution Hybrid (10% oil, 5 mL into 30 mL water + dry activator) | 7.20 | 7.26 | 6.99 |
| V3.3 Dry Make-Fresh Recovery Drink + Oil Micelle/Softgel | 6.72 | 7.67 | 6.76 |

## Rollups

| Formula | Performance support | Recovery/welfare | Commercial readiness |
|---|---:|---:|---:|
| V3.1 Dilution-Labeled Hybrid (5 mL core into 40 mL water + dry activator) | 7.38 | 7.01 | 7.45 |
| V3.2 Light-Core Dilution Hybrid (10% oil, 5 mL into 30 mL water + dry activator) | 7.12 | 7.07 | 7.45 |
| V3.3 Dry Make-Fresh Recovery Drink + Oil Micelle/Softgel | 6.28 | 7.11 | 8.70 |
...
- Final deliverable overall: **7.09/10**
- Biological potential: **7.36/10**
- Formulation feasibility: **7.17/10**
...
| Osmolality / ORS | 129 mOsm/L → PASS | hydration cap 4.00 |
...
| Hydration cap | cap 4.0 | 129 mOsm/L -> PASS: <= 320 mOsm/L — within isotonic-ish hydration band |
| Hydration cap | cap 4.0 | BLOCKING — incomplete ORS hydration profile: Na 13.9 mmol/L below 45; K 3.4 mmol/L below 10; Cl 23.9 mmol/L below 30; glucose 0.0 mmol/L below 30; glucose:Na ratio unavailable |
...
- Osmolality: BLOCKING — incomplete ORS hydration profile: Na 13.9 mmol/L below 45; K 3.4 mmol/L below 10; Cl 23.9 mmol/L below 30; glucose 0.0 mmol/L below 30; glucose:Na ratio unavailable
...
| Hydration / electrolyte balance | 4.00 | 6.89 | Medium | hydration capped at 4.00 by osmolality/electrolyte gate |
...
- Architecture: `wet_core_plus_dry_activator`
- Final deliverable overall: **6.99/10**
- Biological potential: **7.20/10**
- Formulation feasibility: **7.26/10**
...
| Osmolality / ORS | 161 mOsm/L → PASS | hydration cap 4.00 |
...
| Shelf | 0.8 | dry activator removes wet incompatibilities |
| Shelf | -0.3 | oil-phase active distribution assay needed |
| Hydration cap | cap 4.0 | 161 mOsm/L -> PASS: <= 320 mOsm/L — within isotonic-ish hydration band |
| Hydration cap | cap 4.0 | BLOCKING — incomplete ORS hydration profile: Na 18.5 mmol/L below 45; K 4.5 mmol/L below 10; glucose 0.0 mmol/L below 30; glucose:Na ratio unavailable |
...
- Osmolality: BLOCKING — incomplete ORS hydration profile: Na 18.5 mmol/L below 45; K 4.5 mmol/L below 10; glucose 0.0 mmol/L below 30; glucose:Na ratio unavailable
...
- Final deliverable overall: **6.76/10**
- Biological potential: **6.72/10**
- Formulation feasibility: **7.67/10**
...
| Gate | Result | Score / cap |
|---|---|---:|
| Solubility/TDS | PASS; TDS 1.44% w/v | 10.00 |
| Osmolality / ORS | 129 mOsm/L → PASS | hydration cap 4.00 |
...
| Shelf | -0.3 | oil-phase active distribution assay needed |
| Hydration cap | cap 4.0 | 129 mOsm/L -> PASS: <= 320 mOsm/L — within isotonic-ish hydration band |
| Hydration cap | cap 4.0 | BLOCKING — incomplete ORS hydration profile: Na 9.3 mmol/L below 45; K 2.2 mmol/L below 10; Cl 15.9 mmol/L below 30; glucose 0.0 mmol/L below 30; glucose:Na ratio unavailable |

### Physical gate notes
- Shelf: 6+ month target active
- Shelf: oil-phase actives need potency/distribution assay
- Osmolality: 129 mOsm/L -> PASS: <= 320 mOsm/L — within isotonic-ish hydration band
- Osmolality: BLOCKING — incomplete ORS hydration profile: Na 9.3 mmol/L below 45; K 2.2 mmol/L below 10; Cl 15.9 mmol/L below 30; glucose 0.0 mmol/L below 30; glucose:Na ratio unavailable
- Solubility: no bottlenecks; TDS 1.44% w/v
...
| Hydration / electrolyte balance | 4.00 | 6.76 | Medium | hydration capped at 4.00 by osmolality/electrolyte gate |
