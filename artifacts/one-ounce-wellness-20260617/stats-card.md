...
| Metric | 1 oz Welfare-Positive Recovery/Hydration Core (non-fight use) |
|---|---:|
...
| Hydration / electrolyte balance | 2.50 |
| GI tolerance | 8.00 |
| Onset speed | 2.49 |
...
|---|---:|---:|---:|
| 1 oz Welfare-Positive Recovery/Hydration Core (non-fight use) | 4.47 | 7.17 | 4.73 |

## Rollups

| Formula | Performance support | Recovery/welfare | Commercial readiness |
|---|---:|---:|---:|
| 1 oz Welfare-Positive Recovery/Hydration Core (non-fight use) | 4.03 | 5.33 | 8.20 |

## 1 oz Welfare-Positive Recovery/Hydration Core (non-fight use) — calculation notes

- Architecture: `single_wet_bottle`
- Final deliverable overall: **4.73/10**
...
| Osmolality / ORS | 1629 mOsm/L → BLOCK | hydration cap 2.50 |
...
| Hydration cap | cap 2.5 | 1629 mOsm/L -> BLOCK: > 350 mOsm/L — HYPERTONIC. Pulls water into gut lumen, worsens dehydration. Must dilute / cut dose before use as hydration aid. |

### Physical gate notes
- Shelf: 6+ month target active
- Shelf: preservative challenge not validated
- Osmolality: 1629 mOsm/L -> BLOCK: > 350 mOsm/L — HYPERTONIC. Pulls water into gut lumen, worsens dehydration. Must dilute / cut dose before use as hydration aid.
...
| Hydration / electrolyte balance | 2.50 | 6.91 | Medium | hydration capped at 2.50 by osmolality/electrolyte gate |
